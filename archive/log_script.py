...
- Auto-discovers markets from Kalshi elections API (paginated)
- Ranks by liquidity, validates via /orderbook (non-empty books)
- Logs multiple tickers on a schedule
- Writes ALL snapshots into ONE CSV (with 'ticker' column)
- Columns:
    timestamp, ticker,
