TEAM_MAP_NCAA = {
    ...
    "OKST": "Oklahoma St Cowboys", #Oklahoma St Cowgirls for ncaawb
    "ORE": "Oregon Ducks",
...
TEAM_MAP_NBA = {
    ...
    ### ATP Players (key = first 3 letters of last name, value = full name or list if duplicate) ###
    ### Exception: de Minaur ticker is "DE" (2 letters only). de Jong ticker is "DEJ" (de is part of last name). ###
TEAM_MAP_ATP = {
    "ALC": "Carlos Alcaraz",
    "ALT": "Daniel Altmaier",
    "ARN": "Matteo Arnaldi",
    "ATM": "Terence Atmane",
    "AUG": "Felix Auger-Aliassime",
    "BAE": "Sebastian Baez",
    "BAU": "Roberto Bautista Agut",
    "BER": ["Matteo Berrettini", "Zizou Bergs"],
    "BLK": "Alexander Blockx",
    "BOR": "Nuno Borges",
    "BRO": "Jenson Brooksby",
    "BUB": "Alexander Bublik",
    "BUS": "Ignacio Buse",
    "CAR": ["Pablo Carreno Busta", "Camilo Ugo Carabelli"],
    "CAZ": "Arthur Cazaux",
    "CER": ["Francisco Cerundolo", "Juan Manuel Cerundolo"],
    "CIL": "Marin Cilic",
    "COB": "Flavio Cobolli",
    "COL": "Raphael Collignon",
    "COM": "Francisco Comesana",
    "DAR": "Luciano Darderi",
    "DAV": "Alejandro Davidovich Fokina",
    "DE": "Alex de Minaur",
    "DEJ": "Jesper de Jong",
    "DIM": "Grigor Dimitrov",
    "DJO": "Novak Djokovic",
    ...
    "FON": "Joao Fonseca",
    "FRI": "Taylor Fritz",
    "FUC": "Marton Fucsovics",
    "GAR": "Cristian Garin",
    "GRA": "Marcel Granollers",
    "GAS": "Hugo Gaston",
    "GIR": "Marcos Giron",
    "GRI": "Tallon Griekspoor",
    "HAL": "Quentin Halys",
    "HUR": "Hubert Hurkacz",
    "HUM": "Ugo Humbert",
    "KEC": "Miomir Kecmanovic",
    "KHA": "Karen Khachanov",
    "KOR": "Sebastian Korda",
    "KOV": "Aleksandar Kovacevic",
    "MAC": "Tomas Machac",
    "MAJ": "Kamil Majchrzak",
    "MAN": "Adrian Mannarino",
    "MON": "Gaël Monfils",
    "MAR": "Fabian Marozsan",
    "MED": ["Daniil Medvedev", "Hamad Medjedovic"],
    "MEN": "Jakub Mensik",
    "MIC": "Alex Michelsen",
    "MIS": "Filip Misolic",
    "MOU": "Corentin Moutet",
    "MUL": "Alexandre Muller",
    "MUN": "Jaume Munar",
    "MUS": "Lorenzo Musetti",
    "NAK": "Brandon Nakashima",
    "NAV": ["Emilio Nava", "Mariano Navone"],
    "NIS": "Kei Nishikori",
    "NOR": "Cameron Norrie",
    "OPE": "Reilly Opelka",
    "PAU": "Tommy Paul",
    ...
    "QUI": "Ethan Quinn",
    "RAO": "Milos Raonic",
    "RIN": "Arthur Rinderknech",
    "ROY": "Valentin Royer",
    "RUB": "Andrey Rublev",
    "RUN": "Holger Rune",
    "RUU": "Casper Ruud",
    "SHA": "Denis Shapovalov",
    "SHE": ["Ben Shelton", "Alexander Shevchenko"],
    "SIN": "Jannik Sinner",
    "SON": "Lorenzo Sonego",
    "SPI": "Eliot Spizzirri",
    "STR": "Jan-Lennard Struff",
    "SCH": "Tristan Schoolkate",
    "SVR": "Dalibor Svrcina",
    "TAB": ["Alejandro Tabilo", "Carlos Taberner"],
    "TIA": "Frances Tiafoe",
    "TIE": "Learner Tien",
    "TSI": "Stefanos Tsitsipas",
    "VAC": "Valentin Vacherot",
    "VAN": "Botic van de Zandschulp",
    "VUK": "Aleksandar Vukic",
    "WAL": "Adam Walton",
    "ZVE": "Alexander Zverev",
}

    ### WTA Players (key = first 3 letters of last name, value = full name) ###
TEAM_MAP_WTA = {
    "ALE": "Ekaterina Alexandrova",
    "AND": "Mirra Andreeva",
    "ANI": "Amanda Anisimova",
    "AZA": "Victoria Azarenka",
    "BAD": "Paula Badosa",
    "BOU": "Katie Boulter",
    "COL": "Danielle Collins",
    "FER": "Leylah Fernandez",
    "FRE": "Magdalena Frech",
    "GAU": "Coco Gauff",
    "HAD": "Beatriz Haddad Maia",
    "JAB": "Ons Jabeur",
    "KAL": "Anna Kalinskaya",
    "KAS": "Daria Kasatkina",
    "KEY": "Madison Keys",
    "KOS": "Marta Kostyuk",
    "KRE": "Barbora Krejcikova",
    "LIN": "Magda Linette",
    "MER": "Elise Mertens",
    "MUC": "Karolina Muchova",
    "NAV": "Emma Navarro",
    "NOS": "Linda Noskova",
    "OST": "Jelena Ostapenko",
    "PAO": "Jasmine Paolini",
    "PAV": "Anastasia Pavlyuchenkova",
    "PEG": "Jessica Pegula",
    "PLI": "Karolina Pliskova",
    "POT": "Anastasia Potapova",
    "PUT": "Yulia Putintseva",
    "RYB": "Elena Rybakina",
    "SAB": "Aryna Sabalenka",
    "SAK": "Maria Sakkari",
    "SAM": "Liudmila Samsonova",
    "SHN": "Diana Shnaider",
    "SUN": "Lulu Sun",
    "SVI": "Elina Svitolina",
    "SWI": "Iga Swiatek",
    "VEK": "Donna Vekic",
    "VON": "Marketa Vondrousova",
    "WAN": "Wang Xinyu",
    "YAS": "Dayana Yastremska",
    "ZHE": "Zheng Qinwen",
}

# Combined map for non-tennis sports (NCAA + NBA). Tennis uses TEAM_MAP_ATP / TEAM_MAP_WTA.
TEAM_MAP_B = {**TEAM_MAP_NCAA, **TEAM_MAP_NBA}
