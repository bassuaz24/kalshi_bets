...
# Values can be a single key (str) or a list of keys for multiple tournaments (e.g. ATP/WTA)
SPORT_KEYS = {
    #"NFL": "americanfootball_nfl",
    "NBA": "basketball_nba",
    # "CBBM": "basketball_ncaab",
    # "CBBW": "basketball_wncaab",
    "ATP": ["tennis_atp_miami_open"],
    #"tennis_atp_aus_open_singles", "tennis_atp_canadian_open", "tennis_atp_china_open", "tennis_atp_cincinnati_open",
    # "tennis_atp_dubai", "tennis_atp_french_open", "tennis_atp_indian_wells", "tennis_atp_italian_open", "tennis_atp_madrid_open",
    # "tennis_atp_indian_wells", "tennis_atp_monte_carlo_masters", "tennis_atp_paris_masters", "tennis_atp_qatar_open", "tennis_atp_us_open", "tennis_atp_wimbledon"],

    "WTA": ["tennis_wta_miami_open"],
    # "tennis_wta_aus_open_singles", "tennis_wta_canadian_open", "tennis_wta_china_open", "tennis_wta_cincinnati_open",
