...
SPORT_KEYS = {
    ...
    "ATP": ["tennis_atp_qatar", "tennis_atp_dubai"],
    ...
    "WTA": ["tennis_wta_qatar", "tennis_wta_dubai"],
    ...
    # "tennis_wta_miami_open", "tennis_wta_qatar_open", "tennis_wta_us_open", "tennis_wta_wimbledon", "tennis_wta_wuhanC
}
