...
def get_live_positions():
    ...
    try:
        ...
        if settings.VERBOSE and live_positions:
        ...
        elif settings.VERBOSE and not live_positions and data:
            ...
            if market_pos_count > 0 or event_pos_count > 0:
                print(f"⚠️ Found {market_pos_count} market_positions and {event_pos_count} event_positions but couldn't parse any")
