...
#insert api/environment configs here
...
WINNERS_BANKROLL = WINNERS_PROPORTION * TOTAL_BANKROLL
SPREADS_BANKROLL = TOTAL_BANKROLL - WINNERS_BANKROLL
Q1_WEIGHT = 1.00
Q2_WEIGHT = 1.00
Q3_WEIGHT = 1.00
Q4_WEIGHT = 1.00
...
edge_winners_df = combined_winners_df.loc[
    (combined_winners_df['avg_fair_prb'] >= midprice + WINNERS_EDGE) |
    (combined_winners_df['avg_fair_prb'] <= midprice - WINNERS_EDGE)
...
edge_spreads_df = combined_spreads_df.loc[
    (combined_spreads_df['avg_fair_prb'] >= midprice + SPREAD_EDGE) |
    (combined_spreads_df['avg_fair_prb'] <= midprice - SPREAD_EDGE)
].reset_index(drop=True)
